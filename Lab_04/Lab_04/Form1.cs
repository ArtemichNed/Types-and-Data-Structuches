    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i <= kol; i++)
            {
                ...
                if (input.Contains("x"))
                {
                    s = input.Replace("x", a.ToString());
                }

                string output = GetExpression(s); //Преобразовываем выражение в постфиксную запись
        ...
        static private string GetExpression(string input)
        {
            ...
            for (int i = 0; i < input.Length; i++) //Для каждого символа в входной строке
            {
                ...
                {
                    while (!IsDelimeter(input[i + 1]) && !IsOperator(input[i + 1]))
                    {
                        output += input[i + 1]; //Добавляем каждую цифру числа к нашей строке
        ...
        static private double Counting(string input)
        {
            ...
            for (int i = 0; i < input.Length; i++) //Для каждого символа в строке
            {
                ...
                else if (IsOperator(input[i])) //Если символ - оператор
                {
                    ...
                    if (a == 0 && input[i] == '/') { throw new DivideByZeroException(); }
